...
- 👋 Привет, меня зовут Алексей Кольцов. 👀 Я Python разработчик, специализирующийся на Django и Django Rest framework. Cоздаю REST API проекта и размещаю на сервере в контейнерах Docker, также настраиваю CI/CD пайпланы, используя GitHub Actions.
